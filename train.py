...
def get_args_parser():
    ...
    parser.add_argument('--epochs', default=5600, type=int)
    ...
    parser.add_argument('--output_dir', default='./p2g_logs',
                        help='path where to save, empty for no saving')
    parser.add_argument('--checkpoints_dir', default='./p2g_weights',
                        help='path where to save checkpoints, empty for no saving')
    parser.add_argument('--tensorboard_dir', default='./p2g_logs',
                        help='path where to save, empty for no saving')
...
def main(args):
    ...
    data_loader_train = DataLoader(train_set, args.batch_size)
